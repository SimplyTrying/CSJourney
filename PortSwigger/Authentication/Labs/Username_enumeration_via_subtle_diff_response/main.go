...
const (
	...
	LoginURL = "https://ac951f5c1ec3e819c0a9625800a00040.web-security-academy.net/login"
)
...
/*
 - Firstly run only func EnumerateUsername
 - Observe error messages for all users
 - For invlid users error message is: Invalid username or password., but . is
   replaced with space in the error message if user is valid
 - Now Enumerate the password
*/
